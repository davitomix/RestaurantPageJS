...
const run = (() => {
  setMenuItemEventListener('#about', AboutPage.injectAboutPage);
  setMenuItemEventListener('#menu', MenuPage.injectMenuPage);
  setMenuItemEventListener('#contact', ContactPage.injectContactPage);
  console.log('Running...');
});
